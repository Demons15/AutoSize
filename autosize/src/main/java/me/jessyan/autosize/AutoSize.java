 ...
 * 此方案只要应用到 {@link Activity} 上, 这个 {@link Activity} 下的所有 {@link androidx.fragment.app.Fragment}、{@link Dialog}、
...
public final class AutoSize {
    ...
    /**
     * 使用 {@link Activity} 或 {@link androidx.fragment.app.Fragment} 的自定义参数进行适配
     *
     * @param activity    {@link Activity}
     * @param customAdapt {@link Activity} 或 {@link androidx.fragment.app.Fragment} 需实现 {@link CustomAdapt}
     */
    ...
    /**
     * 使用外部三方库的 {@link Activity} 或 {@link androidx.fragment.app.Fragment} 的自定义适配参数进行适配
     *
     * @param activity          {@link Activity}
     * @param externalAdaptInfo 三方库的 {@link Activity} 或 {@link androidx.fragment.app.Fragment} 提供的适配参数, 需要配合 {@link ExternalAdaptManager#addExternalAdaptInfoOfActivity(Class, ExternalAdaptInfo)}
     */
